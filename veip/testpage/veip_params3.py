...
class cput():
    ...
    def trp(self):
        ...
        cursor.execute("""select "n1"*"nol" from "TPS"
                        where "id"=12;""")
        for number_axis in range(cursor.fetchone()[0]):
...
if __name__=="__main__":
    ...
    p.load_from_db(cursor)        # Для чтения из БД
